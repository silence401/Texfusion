...
def dibr_rasterization(height, width, face_vertices_z, face_vertices_image,
                       ...
                       rast_backend='cuda', return_derivatives=False):
    ...
    Returns:
        ...
        - The rendered face index, -1 is None,
          of shape :math:`(\text{batch_size}, \text{height}, \text{width})`.
    """
    if rast_backend == 'nvdiffrast':
        interpolated_features, face_idx, rast, pos, tri = rasterize(
            height, width,
            face_vertices_z,
            face_vertices_image,
            face_features,
    ...
    if rast_backend == 'nvdiffrast':
        return interpolated_features, soft_mask, face_idx, rast, pos, tri
